...
import { TextField, FormControl, Box, InputLabel, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper } from "@mui/material";

import { cleanLabel } from "../../utils/cleanup";
  ...
  return (
    <>
      <FormControl fullWidth sx={{ marginTop: 4 }} variant="standard">
        ...
        {recordInfo.crudAction == "view" && <TextField label={setInnerHTML(data.EA_SA_txtaQuestion)} value={fieldValue} InputProps={{ readOnly: true }} />}
      </FormControl>
    </>
  );
};
