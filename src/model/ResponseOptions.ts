export const fetchResponseOptionsByTemplateId = async (templateID: any) => {
  try {
    ...
    //@ts-ignore
    const results = await _RB.selectQuery(["id", "name", "EA_SA_txtAssmtRespOptCode", "EA_SA_txtLabelColor", "EA_SA_intDisplayOrder"], "EA_SA_AssessmentResponseOption", condition, 10000, true);
